...
export const defaultRolePermissions: Record<Role, string[]> = {
    OWNER: ['/dashboard', '/dashboard/bagan-akun', '/dashboard/jurnal', '/dashboard/kas-bank', '/dashboard/buku-besar', '/dashboard/piutang', '/dashboard/hutang', '/dashboard/kontak', '/dashboard/laporan', '/dashboard/settings/users', '/dashboard/settings/permissions'],
    ADMIN: ['/dashboard', '/dashboard/bagan-akun', '/dashboard/jurnal', '/dashboard/kas-bank', '/dashboard/buku-besar', '/dashboard/piutang', '/dashboard/hutang', '/dashboard/kontak', '/dashboard/laporan', '/dashboard/settings/users', '/dashboard/settings/permissions'],
